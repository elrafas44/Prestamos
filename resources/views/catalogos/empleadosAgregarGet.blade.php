...
<form method="post" action="{{url('/empleados/agregar')}}">
    ...
    <div class="row my-4">
        ...
        <div class="form-group mb-3 col-6">
            ...
            <input type="text" maxlength="50" class="form-control" name="apellidoP" placeholder="Ingrese apellido paterno" id="apellidoP" required autofocus>
        </div>
        <div class="form-group mb-3 col-6">
            <label for="apellidoM">Apellido materno</label>
            <input type="text" maxlength="50" class="form-control" name="apellidoM" placeholder="Ingrese apellido materno" id="apellidoM" required autofocus>
        </div>
        <div class="form-group mb-3 col-6">
